...
// Minio is the overall type for the miniofilesystem filesystem, and contains
...
// getCredentials generates a miniofilesystem client using the credentials stored in
// the Minio type
